...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
	...
	<div id="divUser" runat="server">
		<asp:GridView ID="GVIndivCfsJournal" runat="server" Width="100%" AllowPaging="true" PageSize="30" ShowHeaderWhenEmpty="True"  OnPageIndexChanging="CFSgridView_PageIndexChanging" AllowSorting="True" HeaderStyle="table" FooterStyle="table" OnSorting="Sorting">
		...
		<br />
		<asp:GridView ID="GVIndivPfsJournal" runat="server" Width="100%" AllowPaging="true" PageSize="30" OnPageIndexChanging="PFSgridView_PageIndexChanging" AllowSorting="True" HeaderStyle="table" FooterStyle="table" OnSorting="Sorting" ShowHeaderWhenEmpty="True" >
			<PagerSettings Mode="NumericFirstLast" PageButtonCount="4" FirstPageText="First" LastPageText="Last" />
		</asp:GridView>
